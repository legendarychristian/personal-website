...
export default function ProjectsSection() {
    return (
        <section id="projects" className="min-h-screen bg-offWhite flex flex-col items-center justify-center md:px-20 pt-48 font-nunito">
            <div className="max-w-7xl mx-auto px-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-48 pt-24 max-w-5xl mx-auto text-center">
                    ...
                    <a href="https://github.com/legendarychristian/Transformer-From-Scratch" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center space-y-4 cursor-pointer group">
                        {/* Image Container */}
                        <div className="w-72 h-72 rounded-xl bg-green-300 flex items-center justify-center overflow-hidden transition-transform duration-300 group-hover:shadow-xl group-hover:scale-105">
